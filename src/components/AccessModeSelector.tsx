...
const AccessModeSelectorComp = ({classes, onChange, value, ...rest}: { classes: any, onChange: Function, value: string, [key: string]: any }) => (
    <TextField
        label='Access mode'
...
// @ts-ignore
export default compose(observer, withStyles(styles))(AccessModeSelectorComp);
