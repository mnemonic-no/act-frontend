...
const ObjectRowComp = ({actObject, selectedNode, onRowClick, classes}: {
    actObject: ActObject,
    selectedNode: Node,
    onRowClick: Function,
    classes: any
...
const ObjectsTableComp = ({objects, selectedNode, classes, orderBy, order, onSortChange, onRowClick}: {
